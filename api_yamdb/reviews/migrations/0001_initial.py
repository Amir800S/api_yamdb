# Generated by Django 3.2 on 2023-04-28 15:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reviews.genre', verbose_name='ID жанра')),
            ],
        ),
        migrations.CreateModel(
            name='Title',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Оценка не должна больше 10.'), django.core.validators.MinValueValidator(1, 'Оценка не должна меньше 1.')], verbose_name='Оценка')),
